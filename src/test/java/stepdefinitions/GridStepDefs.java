...
//        remote grid url    
        URL remoteURL = new URL("http://172.16.71.40:4444");
        if(browser.equalsIgnoreCase("chrome")) {
//            initiation remote chrome driver
...
//        going to the url
    ...
    @Then("verify page title contains {string} on grid")
    public void verify_page_title_contains_on_grid(String string) {
