...
//         get all of the data and verify the columns contains adam_admin
    ...
    @Then("verify the table {string} and column {string} contains the data {string}")
    public void verify_the_table_and_column_contains_the_data(String table, String column, String data) {
//       Go to the table and get the column data and store them in a list then do assertion
       String query = "SELECT "+column+"FROM "+table+" ORDER BY id";

//       getting all the current column data and storing in a list using util class
